...
trait HelloAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.hello.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" hello="group" aria-label="Hello Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
